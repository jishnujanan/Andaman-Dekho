...
Dio getDio() {
  ...
  http.options.baseUrl =
      "https://us-central1-andaman-dekho.cloudfunctions.net/api";
  http.options.headers['token'] =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IndiQk5xeWtkblhhcmFpZ3F0S1V4IiwiZW1haWwiOiJqaXNoYW50YUBnbWFpbC5jb20iLCJpYXQiOjE2NDA5NTE2MTh9.lpUuOMpiEAHVEIzJQs1KLB0GizMD3GEmcgBGxszT-YQ';
  print(http);
  return http;
}

Position currPoss = Position(
    longitude: 24.0,
    latitude: 23.0,
